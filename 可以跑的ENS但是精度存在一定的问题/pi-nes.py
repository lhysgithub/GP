...
def main():
    ...
    def get_grad(pt, should_calc_truth=False):
        ...
        for _ in range(10):
            ...
            logitnp,predsnp = TencentAPI.Predict(NewImages,batch_size)
            # 适配修改

            loss, dl_dx_ = sess.run([final_losses, grad_estimate], {x:pt,logitsplaceholder:logitnp,preds:predsnp})
    ...
    for i in range(30):
        ...
        eval_logitsnp, eval_predsnp = TencentAPI.Predict(tempImage, batch_size)
